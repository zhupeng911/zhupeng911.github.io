          ...
          <v-card-text class="mt-4">
            ...
            <div class="mt-6" style="text-align: center">
              <p style="font-size: 15px;">
                {{ $t('home.email') }}: <a href="mailto:377964646@qq.com">377964646@qq.com</a><br />
              </p>
              <a href="https://github.com/zhupeng911" target="_blank">GitHub</a> /
              <a href="https://zhupeng.blog.csdn.net" target="_blank">{{ $t('home.blog') }}</a> /
              <a href="/wechat-qrcode.png">{{ $t('home.wechat') }}</a> /
  ...
  <v-row class="mt-1" justify="center">
    <v-col align-self="center">
      <p style="text-align: center; font-size: 12px; color: #aaa; line-height: 1.5;">
        <v-icon icon="mdi-xml"></v-icon> with <v-icon icon="mdi-heart"></v-icon> by Peng Zhu <br />
